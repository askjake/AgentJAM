...
class Settings(BaseSettings):
    ...
    # Log/Archive file types (stored in agent sandbox, not embedded)
    SUPPORTED_LOG_TYPES: list[str] = [
        ...
        "application/octet-stream",  # Generic binary, often used for .log files
    ]
    ...
    SUPPORTED_EMAIL_TYPES: list[str] = [
        ...
        "application/octet-stream",  # Sometimes used for .eml/.msg
    ]
    ...
    # Agent uploads directory (for log files)
