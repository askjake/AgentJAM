 ...
 * Handles creation, editing, testing, and management of custom AI tools
 */

// ============================================================================
// CONFIGURATION - Use CONFIG from dashboard.js
// ============================================================================

// CONFIG is defined in dashboard.js and loaded first
// If for some reason it's not available, set up a fallback on window object
if (typeof CONFIG === "undefined") {
    console.error("[Custom Tools] CONFIG not found! Dashboard.js should load first.");
    // Emergency fallback - attach to window to avoid conflicts
    if (!window.CONFIG) {
        window.CONFIG = {
...
console.log("[Custom Tools] Using API_BASE_URL:", typeof CONFIG !== 'undefined' ? CONFIG.API_BASE_URL : window.CONFIG.API_BASE_URL);
